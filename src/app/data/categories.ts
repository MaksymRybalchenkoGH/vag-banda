...
export const Categories: Category[] = [
  ...
  },
  {
    ...
    description: {
      main:
        'От правильной работы узлов и агрегатов автомобиля зависит комфорт и безопасность всех участников дорожного движения. Если ломается один из механизмов, то это может вызвать цепную реакцию, которая приведет к серьезным неисправностям и поломкам. По этой причине, при каждом постороннем звуке ходовой, или не привычном ощущении при рулёжке, рекомендуем не затягивать с диагностикой и обнаружением неисправности.\n\nПройти комплексную диагностику автомобиля, или отдельных механизмов в Киеве можно на Banda Service. Комплексная диагностика автомобилей - это проверка авто на предмет работоспособности, исправности, правильности функционирования различных механизмов машины. Сюда входит проверка ходовой части, компьютерная диагностика, визуальный осмотр подкапотного пространства. Своевременно обнаруженные неисправности помогут сэкономить как время, так и деньги в случае необходимости ремонтных работ.',
      additional: '',
      details: []
    },
  ...
  },
  {
    ...
    description: {
      main:
        'Banda Service в Киеве на Софиевской Борщаговке оказывает услуги по замене технических жидкостей всех видов, с использованием высококачественных расходников, материалов и запчастей. Своевременная и качественная замена масла и фильтров, продлевает срок службы двигателя или коробки передач, а также других систем автомобиля. Квалифицированные специалисты Banda Service в Киеве имеют большой опыт по замене технических жидкостей и фильтров и помогут с заменых технических жидкостей в любом агрегате вашего автомобиля.',
      additional: '',
      details: []
    },
    mainImage: 'to',

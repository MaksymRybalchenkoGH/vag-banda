// telegram
export const TG_BOT_API_KEY = '1711090038:AAHK9jrrRC2KUBVV9Gsr0HZRATac0szwRYo'
export const TG_CHAT_ID = '@bndservice'
export const TG_CHAT_URL = `https://api.telegram.org/bot${TG_BOT_API_KEY}/sendMessage?chat_id=${TG_CHAT_ID}&text=`
